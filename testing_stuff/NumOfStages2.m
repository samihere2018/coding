...
str = {[ 'dt = ', num2str(dt) ]; [ 'lambda = ', num2str(lambda) ]; [ 'bisection iterations = ', num2str(iter) ];...
       ['number of stages = ', num2str(s_final) ]};
...
% -------------------------------------------------------------------------
function [alpha_s, beta_s, iter] = bisection(s)
% =========================================================================
