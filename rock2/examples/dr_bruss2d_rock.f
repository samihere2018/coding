...
c-------------------------------------------------------- 
c ----- to integrate with rock2.f 
      dimension y(neqn),work(4*neqn) 
c ----- to integrate with rock4.f 
c     dimension y(neqn),work(7*neqn)
...
c ----- to integrate with rock2.f     
      call rock2(neqn,t,tend,h,y,fbrus,atol,rtol,work,
     &           iwork,idid) 
c ----- call of the subroutine rock4 -----
c      call rock4(neqn,t,tend,h,y,fbrus,atol,rtol,work,
c     &           iwork,idid)    
c ----- print solution -----
      do j=1,neqn,267
        write (8,*) y(j)
