...
c      namelist /list1/ alf, uxadv, uyadv, vxadv, vyadv, wxadv, wyadv,
c     & brussa, brussb, amult
...
110   write(6,*) 'Integration of the 1-dim Brusselator problem, ns=',ns
...
c	radadv=rhoadv(neqn,t,y)
c	write (6,*) 'amult',amult,'adv spectral radius',radadv
      return
      end
